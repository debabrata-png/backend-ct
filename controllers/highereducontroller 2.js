const Pub=require('./../Models/higheredu');
const Link=require('./../Models/uploadlink');


exports.getaddhigheredu= (req,res) => {
    //res.cookie("user","Akshata");
    const user1=req.cookies['user'];
    if(user1) {
        res.status(200).render('addhigheredu', {
            title: 'All students'
        });
...
exports.getviewhigheredu= async (req,res) => {
    //res.cookie("user","Akshata");
    ...
    try{
        ...
        if(user1) {
            ...
            .where('criteria')
            .equals('Student Progression Higher Education')
            .where('colid')
            .equals(colid);
            //res.status(200).send('Hello world for all the tours through db new router');
            res.status(200).render('viewhigheredu', {
                categories: lcat1233,
                link: link123,
...
exports.getedithigheredu= async (req,res) => {
    //res.cookie("user","Akshata");
    ...
    try{
        ...
        if(user1) {
            ...
            res.status(200).render('edithigheredu', {
                pub: leditcat,
                category: leditcat,
                title: 'Edit'
...
exports.createhigheredu= async (req,res) => {
    ...
    try{
        ...
        if(user1) {
            const pub1= await Pub.create({
                ...
                programgrad: req.body.programgrad,
                institution: req.body.institution,
                programadm: req.body.programadm,
...
exports.updatehigheredu= async (req,res) => {
...
exports.deletehigheredu= async (req,res) => {
