const Pub=require('./../Models/reservecat');
const Link=require('./../Models/uploadlink');


exports.getaddreservecat= (req,res) => {
    //res.cookie("user","Akshata");
    const user1=req.cookies['user'];
    if(user1) {
        res.status(200).render('addreservecat', {
            title: 'All reserved category seats'
        });
...
exports.getviewreservecat= async (req,res) => {
    //res.cookie("user","Akshata");
    ...
    try{
        ...
        if(user1) {
            ...
            res.status(200).render('viewreservecat', {
                categories: lcat1233,
                link: link123,
                title: 'List '
...
exports.geteditreservecat= async (req,res) => {
    //res.cookie("user","Akshata");
    ...
    try{
        ...
        if(user1) {
            ...
            res.status(200).render('editreservecat', {
                pub: leditcat,
                category: leditcat,
                title: 'Edit'
...
exports.createreservecat= async (req,res) => {
    ...
    try{
        ...
        if(user1) {
            const pub1= await Pub.create({
                ...
                sancseat: req.body.sancseat,
                studadmt: req.body.studadmt,
       ...
       res.status(200).render('addreservecat', {
        title: 'Add reserved category seats'
    });
        // res.status(400).json({
        //     status:'Failed',
        //     message: err
...
exports.updatereservecat= async (req,res) => {
...
exports.deletereservecat= async (req,res) => {
