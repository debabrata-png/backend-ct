...
exports.getaddcbcs= (req,res) => {
    //res.cookie("user","Akshata");
    const user1=req.cookies['user'];
    if(user1) {
        res.status(200).render('addcbcs', {
            title: 'All Programs'
        });
...
exports.getviewcbcs= async (req,res) => {
    //res.cookie("user","Akshata");
    ...
    try{
        ...
        if(user1) {
            ...
            res.status(200).render('viewcbcs', {
                categories: lcat1233,
                link: link123,
...
exports.getexportcbcs= async (req,res) => {
	...
	worksheet.columns = [
        ...
        { header: 'Year of implemntation', key: 'yearofimplement', width: 30},
...
exports.geteditcbcs= async (req,res) => {
    //res.cookie("user","Akshata");
    ...
    try{
        ...
        if(user1) {
            ...
            res.status(200).render('editcbcs', {
                pub: leditcat,
                category: leditcat,
                title: 'Edit'
...
exports.createcbcs= async (req,res) => {
...
exports.updatecbcs= async (req,res) => {
...
exports.deletecbcs= async (req,res) => {
