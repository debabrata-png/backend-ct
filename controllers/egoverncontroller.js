const Pub=require('./../Models/egovern');
...
exports.getaddegovern= (req,res) => {
    //res.cookie("user","Akshata");
    const user1=req.cookies['user'];
    if(user1) {
        res.status(200).render('addegovern', {
            title: 'All details'
        });
...
exports.getviewegovern= async (req,res) => {
    //res.cookie("user","Akshata");
    ...
    try{
        ...
        if(user1) {
            ...
            res.status(200).render('viewegovern', {
                categories: lcat1233,
                link: link123,
                title: 'List '
...
exports.getexportegovern= async (req,res) => {
	...
	worksheet.columns = [
		...
		{ header: 'Name of Award', key: 'egovernareas', width: 30},
		{ header: 'Type of Participation', key: 'yearofimplement', width: 30},
...
exports.geteditegovern= async (req,res) => {
    //res.cookie("user","Akshata");
    ...
    try{
        ...
        if(user1) {
            ...
            res.status(200).render('editegovern', {
                pub: leditcat,
                category: leditcat,
                title: 'Edit'
...
exports.createegovern= async (req,res) => {
    ...
    try{
        ...
        if(user1) {
            const pub1= await Pub.create({
                ...
                user: user1,
                egovernareas: req.body.egovernareas,
       ...
       res.status(200).render('addegovern', {
        title: 'Add Areas of e governance'
    });
        // res.status(400).json({
        //     status:'Failed',
        //     message: err
...
exports.updateegovern= async (req,res) => {
...
exports.deleteegovern= async (req,res) => {
