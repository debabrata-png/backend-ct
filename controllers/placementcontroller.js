...
exports.getaddplacement= (req,res) => {
    ...
    if(user1) {
        res.status(200).render('addplacement', {
...
exports.getviewplacement= async (req,res) => {
    ...
    try{
        ...
        if(user1) {
            ...
            res.status(200).render('viewplacement', {
                categories: lcat1233,
                link: link123,
...
exports.getexportplacement= async (req,res) => {
	...
	worksheet.columns = [
        ...
        { header: 'Employee contact details', key: 'empcontactdetails', width: 30},
...
exports.geteditplacement= async (req,res) => {
    ...
    try{
        ...
        if(user1) {
            ...
            res.status(200).render('editplacement', {
                pub: leditcat,
                category: leditcat,
                title: 'Edit'
