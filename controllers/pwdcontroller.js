...
exports.getaddpwd= (req,res) => {
    //res.cookie("user","Akshata");
    const user1=req.cookies['user'];
    if(user1) {
        res.status(200).render('addpwd', {
            title: 'All learners'
        });
...
exports.getviewpwd= async (req,res) => {
    //res.cookie("user","Akshata");
    ...
    try{
        ...
        if(user1) {
            ...
            .where('criteria')
            .equals('Student seats against PWD category')
            .where('colid')
            .equals(colid);
            //res.status(200).send('Hello world for all the tours through db new router');
            res.status(200).render('viewpwd', {
                categories: lcat1233,
                link: link123,
...
exports.geteditpwd= async (req,res) => {
    //res.cookie("user","Akshata");
...
exports.createpwd= async (req,res) => {
    ...
    try{
        ...
        if(user1) {
            ...
            totalpwd: req.body.totalpwd,
            pwdenr: req.body.pwdenr,
...
exports.deletepwd= async (req,res) => {
