const Pub=require('./../Models/collab');
...
exports.getaddcollab= (req,res) => {
    //res.cookie("user","Akshata");
    const user1=req.cookies['user'];
    if(user1) {
        res.status(200).render('addcollab', {
            title: 'All Collaborative Activities'
        });
...
exports.getviewcollab= async (req,res) => {
    //res.cookie("user","Akshata");
    ...
    try{
        ...
        if(user1) {
            ...
            res.status(200).render('viewcollab', {
                categories: lcat1233,
                link: link123,
...
exports.getexportcollab= async (req,res) => {
	...
	worksheet.columns = [
		...
		{ header: 'Title of activity', key: 'title', width: 30 },
...
exports.geteditcollab= async (req,res) => {
    //res.cookie("user","Akshata");
    ...
    try{
        ...
        if(user1) {
            ...
            res.status(200).render('editcollab', {
                pub: leditcat,
                category: leditcat,
                title: 'Edit'
    ...
    try{
        ...
        if(user1) {
            const pub1= await Pub.create({
                ...
                activitynature: req.body.activitynature,
        ...
        // });
        res.redirect('/viewcollaboration');
