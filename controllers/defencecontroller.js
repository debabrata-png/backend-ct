const Pub=require('./../Models/defence');
...
exports.getadddefence= (req,res) => {
    //res.cookie("user","Akshata");
    const user1=req.cookies['user'];
    if(user1) {
        res.status(200).render('adddefence', {
            title: 'All learners'
        });
...
exports.getviewdefence= async (req,res) => {
    //res.cookie("user","Akshata");
    ...
    try{
        ...
        if(user1) {
            ...
            .where('criteria')
            .equals('Student seats against Defence Category')
            .where('colid')
            .equals(colid);
            //res.status(200).send('Hello world for all the tours through db new router');
            res.status(200).render('viewdefence', {
                categories: lcat1233,
                link: link123,
...
exports.geteditdefence= async (req,res) => {
    //res.cookie("user","Akshata");
    ...
    try{
        ...
        if(user1) {
            ...
            res.status(200).render('editdefence', {
                pub: leditcat,
                category: leditcat,
                title: 'Edit'
...
exports.createdefence= async (req,res) => {
...
exports.updatedefence= async (req,res) => {
...
exports.deletedefence= async (req,res) => {
