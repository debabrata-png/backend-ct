const Pub=require('./../Models/studschsp');
...
exports.getaddstudschsp= (req,res) => {
    //res.cookie("user","Akshata");
    const user1=req.cookies['user'];
    if(user1) {
        res.status(200).render('addstudschsp', {
            title: 'All Student Scholarship'
        });
...
exports.getexportstudschsp= async (req,res) => {
	...
	worksheet.columns = [
		...
		{ header: 'Students benefitted fromgovernment scheme', key: 'noofgovstud', width: 30},
        { header: 'Amount from government', key: 'amountgov', width: 30},
        { header: 'Students benefitted from institutional scheme', key: 'noofinststud', width: 30},
        { header: 'Amount from institution', key: 'amountinst', width: 30},
...
exports.geteditstudschsp= async (req,res) => {
    //res.cookie("user","Akshata");
    ...
    try{
        ...
        if(user1) {
            ...
            res.status(200).render('editstudschsp', {
                pub: leditcat,
                category: leditcat,
                title: 'Edit'
...
exports.createstudschsp= async (req,res) => {
    ...
    try{
        ...
        if(user1) {
            const pub1= await Pub.create({
                ...
                noofgovstud: req.body.noofgovstud,
                amountgov: req.body.amountgov,
                noofinststud: req.body.noofinststud,
                amountinst: req.body.amountinst,
...
exports.updatestudschsp= async (req,res) => {
...
exports.deletestudschsp= async (req,res) => {
