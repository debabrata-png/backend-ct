const Pub=require('./../Models/co');
const Link=require('./../Models/uploadlink');


exports.getaddco= (req,res) => {
    //res.cookie("user","Akshata");
    const user1=req.cookies['user'];
    if(user1) {
        res.status(200).render('addco', {
            title: 'All CO'
        });
...
exports.getviewco= async (req,res) => {
    //res.cookie("user","Akshata");
...
exports.geteditco= async (req,res) => {
    //res.cookie("user","Akshata");
