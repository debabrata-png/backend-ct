const Pub=require('./../Models/extevaluation');
...
exports.getaddextevaluation= (req,res) => {
    //res.cookie("user","Akshata");
    const user1=req.cookies['user'];
    if(user1) {
        res.status(200).render('addextevaluation', {
...
exports.getviewextevaluation= async (req,res) => {
    //res.cookie("user","Akshata");
    ...
    try{
        ...
        if(user1) {
            ...
            .where('criteria')
            .equals('External Evaluators')
            .where('colid')
            .equals(colid);
            //res.status(200).send('Hello world for all the tours through db new router');
            res.status(200).render('viewextevaluation', {
                categories: lcat1233,
                link: link123,
...
exports.geteditextevaluation= async (req,res) => {
    //res.cookie("user","Akshata");
    ...
    try{
        ...
        if(user1) {
            ...
            res.status(200).render('editextevaluation', {
                pub: leditcat,
                category: leditcat,
                title: 'Edit'
...
exports.createextevaluation= async (req,res) => {
    ...
    try{
        ...
        // });
        res.redirect('/viewextevaluation');
...
exports.updateextevaluation= async (req,res) => {
...
exports.deleteextevaluation= async (req,res) => {
