...
const Pat=require('./../Models/publications');
...
exports.getaddbulkpub= (req,res) => {
    //res.cookie("user","Akshata");
    const user1=req.cookies['user'];
    console.log(user1);
    if(user1) {
        res.status(200).render('addbulkpub', {
...
// exports.getaddbulkcollab= (req,res) => {
//     //res.cookie("user","Akshata");
//     const user1=req.cookies['user'];
//     console.log(user1);
//     if(user1) {
//         res.status(200).render('addbulkcollab', {
