const Pub=require('./../Models/employed');
...
exports.getaddemployed= (req,res) => {
    //res.cookie("user","Akshata");
    const user1=req.cookies['user'];
    if(user1) {
        res.status(200).render('addemployed', {
            title: 'All Faculty'
        });
...
exports.getviewemployed= async (req,res) => {
    //res.cookie("user","Akshata");
    ...
    try{
        ...
        if(user1) {
            ...
            .where('criteria')
            .equals('Student seats against Employability Category')
            .where('colid')
            .equals(colid);
            //res.status(200).send('Hello world for all the tours through db new router');
            res.status(200).render('viewemployed', {
                categories: lcat1233,
                link: link123,
...
exports.geteditemployed= async (req,res) => {
    //res.cookie("user","Akshata");
    ...
    try{
        ...
        if(user1) {
            ...
            res.status(200).render('editemployed', {
                pub: leditcat,
                category: leditcat,
                title: 'Edit'
...
exports.createemployed= async (req,res) => {
    ...
    try{
        ...
        if(user1) {
            ...
            notemployed: req.body.notemployed,
...
exports.updateemployed= async (req,res) => {
...
exports.deleteemployed= async (req,res) => {
