const Pub=require('./../Models/awards');
const Link=require('./../Models/uploadlink');


exports.getaddawards= (req,res) => {
    //res.cookie("user","Akshata");
    const user1=req.cookies['user'];
    if(user1) {
        res.status(200).render('addawards', {
            title: 'All awards'
        });
...
exports.getviewawards= async (req,res) => {
    //res.cookie("user","Akshata");
    ...
    try{
        ...
        if(user1) {
            ...
            .where('criteria')
            .equals('Student Awards')
            .where('colid')
            .equals(colid);
            //res.status(200).send('Hello world for all the tours through db new router');
            res.status(200).render('viewawards', {
                categories: lcat1233,
                link: link123,
...
exports.geteditawards= async (req,res) => {
    //res.cookie("user","Akshata");
    ...
    try{
        ...
        if(user1) {
            ...
            res.status(200).render('editawards', {
                pub: leditcat,
                category: leditcat,
                title: 'Edit'
