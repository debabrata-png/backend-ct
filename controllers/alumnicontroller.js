const Pub=require('./../Models/alumni');
...
exports.getaddalumni= (req,res) => {
    //res.cookie("user","Akshata");
    const user1=req.cookies['user'];
    if(user1) {
        res.status(200).render('addalumni', {
            title: 'All alumni'
        });
...
exports.getviewalumni= async (req,res) => {
    //res.cookie("user","Akshata");
    ...
    try{
        ...
        if(user1) {
            ...
            .where('criteria')
            .equals('Alumni Learners')
            .where('colid')
            .equals(colid);
            //res.status(200).send('Hello world for all the tours through db new router');
            res.status(200).render('viewalumni', {
                categories: lcat1233,
                link: link123,
...
exports.geteditalumni= async (req,res) => {
    //res.cookie("user","Akshata");
    ...
    try{
        ...
        if(user1) {
            ...
            res.status(200).render('editalumni', {
                pub: leditcat,
                category: leditcat,
                title: 'Edit'
...
exports.createalumni= async (req,res) => {
    ...
    try{
        ...
        if(user1) {
            ...
            user: user1,
            year: req.body.year,
            learnerenr: req.body.learnerenr,
