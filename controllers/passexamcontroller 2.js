const Pub=require('./../Models/passexam');
const Link=require('./../Models/uploadlink');


exports.getaddpassexam= (req,res) => {
    //res.cookie("user","Akshata");
    const user1=req.cookies['user'];
    if(user1) {
        res.status(200).render('addpassexam', {
            title: 'All students'
        });
...
exports.getviewpassexam= async (req,res) => {
    //res.cookie("user","Akshata");
    ...
    try{
        ...
        if(user1) {
            ...
            res.status(200).render('viewpassexam', {
                categories: lcat1233,
                link: link123,
                title: 'List students'
...
exports.geteditpassexam= async (req,res) => {
    //res.cookie("user","Akshata");
    ...
    try{
        ...
        if(user1) {
            ...
            res.status(200).render('editpassexam', {
                pub: leditcat,
                category: leditcat,
                title: 'Edit'
...
exports.createpassexam= async (req,res) => {
    ...
    try{
        ...
        if(user1) {
            const pub1= await Pub.create({
                ...
                studappear: req.body.studappear,
                studpass: req.body.studpass,
...
exports.updatepassexam= async (req,res) => {
...
exports.deletepassexam= async (req,res) => {
