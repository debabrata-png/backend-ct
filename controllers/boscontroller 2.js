const Pub=require('./../Models/bos');
const Link=require('./../Models/uploadlink');


exports.getaddbos= (req,res) => {
    //res.cookie("user","Akshata");
    const user1=req.cookies['user'];
    if(user1) {
        res.status(200).render('addbos', {
            title: 'All Faculty'
        });
...
exports.getviewbos= async (req,res) => {
    //res.cookie("user","Akshata");
...
exports.geteditbos= async (req,res) => {
    //res.cookie("user","Akshata");
    ...
    try{
        ...
        if (role == 'Admin') {
            ...
            const pub1= await Pub.create({
                ...
                academicbody: req.body.academicbody,
...
exports.updatebos= async (req,res) => {
...
exports.deletebos= async (req,res) => {
