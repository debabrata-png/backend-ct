const Pub=require('./../Models/higherexam');
const Link=require('./../Models/uploadlink');


exports.getaddhigherexam= (req,res) => {
    //res.cookie("user","Akshata");
    const user1=req.cookies['user'];
    if(user1) {
        res.status(200).render('addhigherexam', {
            title: 'All students'
        });
...
exports.getviewhigherexam= async (req,res) => {
    //res.cookie("user","Akshata");
    ...
    try{
        ...
        if(user1) {
            ...
            res.status(200).render('viewhigherexam', {
                categories: lcat1233,
                link: link123,
...
exports.getedithigherexam= async (req,res) => {
    //res.cookie("user","Akshata");
    ...
    try{
        ...
        if(user1) {
            ...
            res.status(200).render('edithigherexam', {
                pub: leditcat,
                category: leditcat,
                title: 'Edit'
...
exports.createhigherexam= async (req,res) => {
...
exports.updatehigherexam= async (req,res) => {
...
exports.deletehigherexam= async (req,res) => {
