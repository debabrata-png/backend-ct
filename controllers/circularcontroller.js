const Pub=require('./../Models/circular');
const Link=require('./../Models/uploadlink');


exports.getaddcircular= (req,res) => {
    //res.cookie("user","Akshata");
    const user1=req.cookies['user'];
    if(user1) {
        res.status(200).render('addcircular', {
            title: 'Circular'
        });
...
exports.getviewcircular= async (req,res) => {
    //res.cookie("user","Akshata");
    ...
    try{
        ...
        if(user1) {
            ...
            res.status(200).render('viewcircular', {
                categories: lcat1233,
                link: link123,
                title: 'List of Circulars'
...
exports.geteditcircular= async (req,res) => {
    //res.cookie("user","Akshata");
    ...
    try{
        ...
        if(user1) {
            ...
            res.status(200).render('editcircular', {
                pub: leditcat,
                category: leditcat,
                title: 'Edit'
