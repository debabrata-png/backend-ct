const Pub=require('./../Models/seedm');
...
exports.getaddseedm= (req,res) => {
    //res.cookie("user","Akshata");
    const user1=req.cookies['user'];
    if(user1) {
        res.status(200).render('addseedm', {
            title: 'All faculty'
        });
...
exports.getviewseedm= async (req,res) => {
    //res.cookie("user","Akshata");
    ...
    try{
        ...
        if(user1) {
            ...
            res.status(200).render('viewseedm', {
                categories: lcat1233,
                link: link123,
...
exports.getexportseedm= async (req,res) => {
	...
	worksheet.columns = [
		...
		{ header: 'Faculty Name', key: 'fname', width: 30},
...
exports.geteditseedm= async (req,res) => {
    //res.cookie("user","Akshata");
    ...
    try{
        ...
        if(user1) {
            ...
            res.status(200).render('editseedm', {
                pub: leditcat,
                category: leditcat,
                title: 'Edit'
...
exports.createseedm= async (req,res) => {
...
exports.updateseedm= async (req,res) => {
...
exports.deleteseedm= async (req,res) => {
