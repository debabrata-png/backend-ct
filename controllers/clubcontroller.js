const Pub=require('./../Models/club');
const Pub1=require('./../Models/clubenr');
const Link=require('./../Models/uploadlink');


exports.getaddclub= (req,res) => {
    //res.cookie("user","Akshata");
    const user1=req.cookies['user'];
    if(user1) {
        res.status(200).render('addclub', {
            title: 'All Clubs'
        });
...
exports.getviewclub= async (req,res) => {
    ...
    try{
        ...
        if(user1) {
            ...
            res.status(200).render('viewclub', {
                categories: lcat1233,
                link: link123,
                title: 'List of clubs'
...
exports.getviewclubregistrations= async (req,res) => {
    //res.cookie("user","Akshata");
    ...
    try{
        ...
        if(user1) {
            ...
            .equals(colid)
            .where('clubcode')
            .equals(req.query.clubcode);
           
            //res.status(200).send('Hello world for all the tours through db new router');
            res.status(200).render('viewclubregistrations', {
                categories: lcat1233,
...
exports.geteditclub= async (req,res) => {
    //res.cookie("user","Akshata");
    ...
    try{
        ...
        if(user1) {
            ...
            res.status(200).render('editclub', {
                pub: leditcat,
                category: leditcat,
                title: 'Edit'
