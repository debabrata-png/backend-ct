const Pub=require('./../Models/gender');
...
exports.getaddgender= (req,res) => {
    //res.cookie("user","Akshata");
    const user1=req.cookies['user'];
    if(user1) {
        res.status(200).render('addgender', {
            title: 'All learners'
        });
...
exports.getviewgender= async (req,res) => {
    //res.cookie("user","Akshata");
    ...
    try{
        ...
        if(user1) {
            ...
            .where('criteria')
            .equals('Student seats against Gender category')
            .where('colid')
            .equals(colid);
            //res.status(200).send('Hello world for all the tours through db new router');
            res.status(200).render('viewgender', {
                categories: lcat1233,
                link: link123,
...
exports.geteditgender= async (req,res) => {
    //res.cookie("user","Akshata");
    ...
    try{
        ...
        if(user1) {
            ...
            res.status(200).render('editgender', {
                pub: leditcat,
                category: leditcat,
                title: 'Edit'
