const Pub=require('./../Models/syllabusrev');
...
exports.getaddsyllabusrev= (req,res) => {
    //res.cookie("user","Akshata");
    const user1=req.cookies['user'];
    if(user1) {
        res.status(200).render('addsyllabusrev', {
            title: 'All Syllabus Revision'
        });
...
exports.getviewsyllabusrev= async (req,res) => {
    //res.cookie("user","Akshata");
    ...
    try{
        ...
        if(user1) {
            ...
            res.status(200).render('viewsyllabusrev', {
                categories: lcat1233,
                link: link123,
...
exports.getexportsyllabusrev= async (req,res) => {
	...
	worksheet.columns = [
		...
		{ header: 'Program anme', key: 'programname', width: 30},
        { header: 'Year of introduction', key: 'yearofintro', width: 30},
        { header: 'Status of implementation', key: 'statusofimplement', width: 30},
        { header: 'Year of implementation', key: 'yearofimplement', width: 30},
        { header: 'Year of revision', key: 'yearofrevision', width: 30},
        { header: 'Percentage change', key: 'changepercent', width: 30},
...
exports.geteditsyllabusrev= async (req,res) => {
    //res.cookie("user","Akshata");
    ...
    try{
        ...
        if(user1) {
            ...
            res.status(200).render('editsyllabusrev', {
                pub: leditcat,
                category: leditcat,
                title: 'Edit'
...
exports.createsyllabusrev= async (req,res) => {
    ...
    try{
        ...
        if(user1) {
            const pub1= await Pub.create({
                ...
                statusofimplement: req.body.statusofimplement,
                yearofimplement: req.body.yearofimplement,
...
exports.updatesyllabusrev= async (req,res) => {
...
exports.deletesyllabusrev= async (req,res) => {
