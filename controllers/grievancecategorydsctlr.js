const Grievancecategoryds = require('../Models/grievancecategoryds');

// Add new category
exports.addgrievancecategoryds = async (req, res) => {
  try {
...
exports.getallgrievancecategoryds = async (req, res) => {
  try {
...
// Delete category
exports.deletegrievancecategoryds = async (req, res) => {
  try {
