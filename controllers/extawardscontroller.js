const Pub=require('./../Models/extawards');
...
exports.getaddextawards= (req,res) => {
    //res.cookie("user","Akshata");
    const user1=req.cookies['user'];
    if(user1) {
        res.status(200).render('addextawards', {
            title: 'All Institutuional Awards/Recognitions'
        });
...
exports.getviewextawards= async (req,res) => {
    //res.cookie("user","Akshata");
    ...
    try{
        ...
        if(user1) {
            ...
            res.status(200).render('viewextawards', {
                categories: lcat1233,
                link: link123,
...
exports.geteditextawards= async (req,res) => {
    //res.cookie("user","Akshata");
    ...
    try{
        ...
        if(user1) {
            ...
            res.status(200).render('editextawards', {
                pub: leditcat,
                category: leditcat,
                title: 'Edit'
...
exports.createextawards= async (req,res) => {
    ...
    try{
       ...
       res.status(200).render('addextawards', {
        title: 'Add Institutional Awards'
    });
        // res.status(400).json({
        //     status:'Failed',
        //     message: err
...
exports.updateextawards= async (req,res) => {
...
exports.deleteextawards= async (req,res) => {
