...
const zScoreConfigurationSchema = new mongoose.Schema(
  {
...
zScoreConfigurationSchema.index({
  colid: 1,
  academicyear: 1,
  regulation: 1,
  programcode: 1,
...
module.exports = mongoose.model("zscoreconfigurationds", zScoreConfigurationSchema);
